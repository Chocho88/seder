...
const DICT: Record<string, { en: string; he: string }> = {
  ...
  import_md: { en: 'Import from .md file', he: 'ייבוא מקובץ .md' },
  toast_md_imported: { en: 'Imported {n} tasks into {m} lists', he: 'יובאו {n} משימות ל-{m} רשימות' },
  toast_md_empty: { en: 'No tasks found in that file', he: 'לא נמצאו משימות בקובץ' },
